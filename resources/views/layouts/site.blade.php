    ...
    <div class="main-wrapper flex-container">
        ...
        <ul>
            <li class="footer__links">
                ...
                <a href=" https://www.instagram.com/iwsouza" target="_blank">Instagram</a>
                <a href="https://www.youtube.com/c/RudimentarC?sub_confirmation=1" target="_blank">Rudimentar</a>
            </li>
            <li class="footer__links">
            ...
            <li class="footer__links">
                ...
                <a title="Clique no email para enviar email automatico" href="mailto:wesley.souzapw@gmail.com
                .br">Email</a>
            </li>
        </ul>
    </div>
